...
void loop()
{
  ...
  {
    // view the current level and score on the LCD screen
    lcd.clear();
    lcd.setCursor(0, 0);
    lcd.print("Level: ");
    lcd.print(level);
...
void wrong_sequence()
{
  ...
  // for (int i = 0; i < 3;  i++)
  // {
  //   // blink all LEDs 3 times if the input sequence is wrong
  //   digitalWrite(2, HIGH);
  //   digitalWrite(3, HIGH);
  //   digitalWrite(4, HIGH);
  //   digitalWrite(5, HIGH);
...
void right_sequence()
{
  ...
  // digitalWrite(5, LOW);
  // delay(250);
  // // blink all LEDs once if the input sequence is correct
  // digitalWrite(2, HIGH);
  // digitalWrite(3, HIGH);
  // digitalWrite(4, HIGH);
  // digitalWrite(5, HIGH);
